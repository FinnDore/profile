...
export const SpotifyStatus = () => {
    ...
    return (
        <div className="spotify-status pointer-events-none flex w-[calc(100vw-.5rem)] max-w-[calc(100vw-0.5rem)] flex-col rounded-md text-white">
            <div className="relative mx-1 my-2 flex w-full max-w-full justify-between px-1 py-1 sm:p-0">
                <div
                ...
                >
                    ...
                    >
                        <h2 className="px-2 pt-2 text-xs font-bold uppercase sm:px-4 sm:pt-4">
                            My top songs:
                        </h2>

                        <TopSongs />
                        <Separator className="mx-4 my-3 h-0.5 rounded bg-[#C9C9C9]/20 sm:mx-8 " />

                        <h2 className="px-2 text-xs font-bold uppercase sm:px-4">
                            Currently playing:
                        </h2>
                    </animated.div>
                    ...
                    <animated.div
                        style={spring}
                        className={clsx(
                            "absolute top-0 -z-10 h-full w-full min-w-[250px] rounded-lg border bg-black/50 bg-blend-difference backdrop-blur-[2px]",
                            {
                                "pointer-events-auto": isHovering,
                            },
                        )}
...
const Song = ({
    ...
    return (
        <div
            className={clsx(
                "spotify-status flex rounded-md px-2 py-2 text-white sm:p-4",
                {
                    "sm:py-2": small,
                },
            )}
...
const Controls = (props: { currentSong: CurrentSong }) => {
    ...
    return (
        <div className="pointer-events-auto relative mt-auto h-max">
            <div className="absolute h-full w-full bg-black/80 blur-lg"></div>
            <button className="px-2 py-1 opacity-60 transition-opacity hover:opacity-90 sm:py-4">
                <TrackPreviousIcon
